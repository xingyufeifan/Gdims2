...
#import "NDImagePickerUtils.h"
#import <AVFoundation/AVFoundation.h>
#import <AssetsLibrary/AssetsLibrary.h>
#import <MobileCoreServices/MobileCoreServices.h>


@interface NDImagePickerUtils ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate>
{
    ZXTakeEndAction action;
}
@end

@implementation NDImagePickerUtils
-(void)takePhotoUponVC:(UIViewController *)vc
              callBack:(ZXTakeEndAction)callBack{
    action = callBack;
    if ([NDImagePickerUtils isCameraAvailable] &&
        [NDImagePickerUtils doesCameraSupportTakingPhotos]) {
        ...
        if ([NDImagePickerUtils isAuthorized_jumpToSettingifNo:true]) {
...
- (void)choosePhotoUponVC:(UIViewController *)vc
                 callBack:(ZXTakeEndAction)callBack{
    action = callBack;
    if ([NDImagePickerUtils isPhotoLibraryAvailable]) {
        UIImagePickerController * pickerVC = [[UIImagePickerController alloc] init];
        pickerVC.view.backgroundColor = [UIColor whiteColor];
        pickerVC.sourceType = UIImagePickerControllerSourceTypePhotoLibrary;
        NSMutableArray * mediaTypes = [NSMutableArray array];
        if ([NDImagePickerUtils canUsePickVideosFromPhotoLibrary]) {
